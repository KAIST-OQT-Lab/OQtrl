...
class sequence:    
        ...
        def append(self,slaveSequence):
            if isinstance(slaveSequence,sequence.slaveSequence):
                ...
                if not isinstance(slaveSequence, list|tuple):
                    raise TypeError("slaveSequence should be sequence.slaveSequence or list,tuple of sequence.slaveSequence")
                else:
    ...
    class project(adwinSequence):
        ...
        def append(self,masterSequences,order:int=None) -> None:
            ...
            #Check if masterSequences is list,tuple or dictionary of sequence.masterSequence
                ...
                if not isinstance(masterSequences, list|tuple|dict):   
                    raise TypeError("masterSequences should be sequence.masterSequence or list,tuple or dictionary of sequence.masterSequence")
                else:
                    NotImplementedError
        ...
        def swap(self,key_1:int,key_2:int) -> None:
            ...
            self.__data_settings = miscs.swap_dict_value(dictionary=self.__data_settings,keys=order)
...
class masterSequenceProcessor():
    ...
    def __init__(self,slaveSequences:List[sequence.slaveSequence]=None,settings:adset.masterSequenceSetting=None)->None:
        ...
        self.DO_slaves, self.AO_slaves, self.DI_slaves, self.AI_slaves = miscs.slaves_seq_finder(self.slaveSequences)
    ...
    def __merge_slaves_DO(self):
            ...
            dump_slaves = [sequence.pattern(types='DO',
                                            duration=duration,
                                            update_period=self.settings.DO.DO_FIFO_UPDATE_PERIOD,
                                            channel=ch
...
class manager():
    ...
    def start(self,project:str=None,**kwargs):
        ...
        if project is None:
            ...
            if not project in self.__projects.keys():
